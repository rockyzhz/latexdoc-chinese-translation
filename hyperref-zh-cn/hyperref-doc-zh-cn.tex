...
\AtBeginEnvironment{cmdsyntax}{\color{spot}}
...
设置\marginpar{\footnotesize \heiti \color{spot}{已弃用 2022-04-27 v7.00o}}锚点时(例如，通过 \verb|\refstepcounter|)，锚点名称将全局设置为当前锚点名称。
